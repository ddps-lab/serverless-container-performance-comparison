...
go run run_bench.go --model_name "unknown" --task_num 100 --log_group_name "unknown" --server_address $server_address --gcp_run_prefix "unknown" --gcp_run_default_address "unknown"
sleep 5
go run run_bench.go --model_name "unknown" --task_num 100 --log_group_name "unknown" --server_address $server_address --gcp_run_prefix "unknown" --gcp_run_default_address "unknown"
sleep 5
